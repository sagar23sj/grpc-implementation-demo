...
type GreetServiceClient interface {
	...
	//Unary Streaming with Error Handling
...
func (c *greetServiceClient) GreetWithErrorHandling(ctx context.Context, in *GreetWithErrorHandlingRequest, opts ...grpc.CallOption) (*GreetWithErrorHandlingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greet.GreetService/GreetWithErrorHandling", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGreetServiceServer) GreetWithErrorHandling(context.Context, *GreetWithErrorHandlingRequest) (*GreetWithErrorHandlingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GreetWithErrorHandling not implemented")
}
